...
public final class DateTimeExpressionFunctionsTest implements PublicStaticHelperTesting<DateTimeExpressionFunctions> {

    @Test
    public void testExpressionFunctionProvider() {
        this.checkEquals(
                Arrays.stream(DateTimeExpressionFunctions.class.getDeclaredMethods())
    ...
    @Override
    public Class<DateTimeExpressionFunctions> type() {
        return DateTimeExpressionFunctions.class;
    }
