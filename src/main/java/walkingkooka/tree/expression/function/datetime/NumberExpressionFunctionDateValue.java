...
final class NumberExpressionFunctionDateValue<C extends ExpressionFunctionContext> extends NumberExpressionFunction<C> {

    static <C extends ExpressionFunctionContext> NumberExpressionFunctionDateValue<C> instance() {
